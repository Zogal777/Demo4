...
<template>
  <section>
    <header class="mb-4">
      ...
      <p class="mt-1 text-sm text-gray-600">Edit contact persons for the client.</p>
    </header>

    <div class="space-y-4">
      <div v-for="(contact, index) in props.form.contacts" :key="index" class="border p-4 rounded">
        <div class="mb-2">
